...
public class Ordelist_GetUpdate extends AsyncTask<Object,Integer,List<OrderlistVO>> {
    private final static String TAG = "Ordelist_GetUpdate";
    private final static String ACTION = "getOrdelist_Update";
