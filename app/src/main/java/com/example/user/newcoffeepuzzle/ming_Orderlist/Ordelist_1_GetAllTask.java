...
public class Ordelist_1_GetAllTask extends AsyncTask<Object,Integer,List<OrderlistVO>> {
    private final static String TAG = "Ordelist_1_GetAllTask";
    private final static String ACTION = "getOrdelist_1";
