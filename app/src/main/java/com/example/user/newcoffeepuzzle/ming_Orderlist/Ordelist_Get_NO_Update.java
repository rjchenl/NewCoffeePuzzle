...
public class Ordelist_Get_NO_Update extends AsyncTask<Object,Integer,List<OrderlistVO>> {
    private final static String TAG = "Ordelist_Get_NO_Update";
    private final static String ACTION = "getOrdelist_NO_Update";
