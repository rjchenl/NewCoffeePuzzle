...
public class Orderdetail_3 extends AppCompatActivity {
    private final static String TAG = "Orderdetail_3";
    private RecyclerView ry_orderdetail_3;
    String store_id,ord_id_3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ming_orderdetail_3_recyclerview);

        Profile_ming profile_ming = new Profile_ming(this);
        store_id = profile_ming.getStoreId();

        ry_orderdetail_3 = (RecyclerView) findViewById(R.id.ry_orderdetail_3);
        ry_orderdetail_3.setLayoutManager(new LinearLayoutManager(this));

        Bundle bundle = getIntent().getExtras();
        ord_id_3 = bundle.getString("ord_id_3");
    }
    @Override
    public void onStart(){
        super.onStart();
        if (Common_ming.networkConnected(this)){
            ...
            try {
                orderdetailVOlist = new Orderdetail_3_GetAll().execute(url,store_id,ord_id_3).get();
            }catch (Exception e){
                e.printStackTrace();
            ...
            if (orderdetailVOlist == null || orderdetailVOlist.isEmpty()){
                ...
                ry_orderdetail_3.setAdapter(new Orderdetail_3.Orderdetail_RecyclerViewAdapter(this, orderdetailVOlist));
    ...
    public class Orderdetail_RecyclerViewAdapter extends RecyclerView.Adapter <Orderdetail_3.Orderdetail_RecyclerViewAdapter.ViewHolder>{
        ...
        @Override
        public Orderdetail_3.Orderdetail_RecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemview = layoutInflater.inflate(R.layout.ming_orderdetail_item,parent,false);
            return new Orderdetail_3.Orderdetail_RecyclerViewAdapter.ViewHolder(itemview);
        }

        @Override
        public void onBindViewHolder(Orderdetail_3.Orderdetail_RecyclerViewAdapter.ViewHolder holder, int position) {
