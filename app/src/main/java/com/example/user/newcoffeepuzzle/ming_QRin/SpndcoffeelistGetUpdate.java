...
public class SpndcoffeelistGetUpdate extends AsyncTask<Object,Integer,Intent>{
    private final static String TAG = "SpndcoffeelistGetUpdate";
    private final static String ACTION = "getUpdate";
